...
conky.config = {
    ...
    border_width = 1,
    cpu_avg_samples = 32,
    default_color = '#F0F8FF',  -- Yogurt (Blanco cremoso)
    default_outline_color = '#F0F8FF',  -- Yogurt (Blanco cremoso)
    default_shade_color = '#B0C4DE',  -- Azul claro (similar a un blueberry suave)
    color1 = '#B0C4DE',  -- Azul claro (Blueberry)
    double_buffer = true,
    draw_borders = false,
...
${color1}${font ConkySymbols:size=16}f${font} ${voffset -10} Sistema » $hr${color}
...
${color1}${font ConkySymbols:size=16}k${font} ${voffset -10} Disco Duro » $hr${color}
