...
conky.config = {
    ...
    border_width = 1,
    cpu_avg_samples = 32,
    default_color = '#FFFFE0',  -- Amarillo pálido
    default_outline_color = '#FFFFE0',  -- Amarillo pálido
    default_shade_color = '#F0E68C',  -- Amarillo claro
    color1 = '#F0E68C',  -- Amarillo claro
    double_buffer = true,
    draw_borders = false,
...
${color1}${goto 35}Read--> ${color}${diskio_read} ${goto 35}
${color1}${goto 35}Write --> ${color}${diskio_write} ${goto 35}
