...
conky.config = {
    ...
    default_color = '#FFFFFF',  -- Blanco para fondo oscuro
    default_outline_color = '#FFFFFF',  -- Blanco para fondo oscuro
    default_shade_color = '#000000',  -- Negro para sombra
    color1 = '#FFFFFF',  -- Blanco para texto principal
    color2 = '#B0B0B0',  -- Gris claro para detalles
    color3 = '#E0E0E0',  -- Gris más claro para secciones
    color4 = '#A0A0A0',  -- Gris suave para títulos
    double_buffer = true,
    draw_borders = false,
...
${color2}${font ConkySymbols:size=16}J${font} ${voffset -10} Memory » $hr${color}
