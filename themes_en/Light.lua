...
conky.config = {
    ...
    default_color = '#000000',  -- Negro para fondo claro
    default_outline_color = '#000000',  -- Negro para fondo claro
    default_shade_color = '#FFFFFF',  -- Blanco para sombra
    color1 = '#000000',  -- Negro para texto principal
    color2 = '#303030',  -- Gris oscuro para detalles
    color3 = '#505050',  -- Gris medio para secciones
    color4 = '#707070',  -- Gris suave para títulos
    double_buffer = true,
    draw_borders = false,
